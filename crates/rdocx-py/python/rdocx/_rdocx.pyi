...
__all__ = [
    ...
    "Comment", "ComparisonDiagnostic", "ContentFragment", "Document", "Font",
    "HeaderFooterVariant", "Hyperlink", "LayoutFragment", "LayoutPage", "Paragraph",
    "ParagraphCollection", "ParagraphFormat", "Row", "RowCollection", "Run",
    "RunCollection", "RunPosition", "RunRange", "Section", "Story", "StoryItem",
    "Style", "Table", "TableCollection", "TocRebuildReport",
]
...
class ContentFragment:
    ...
    @staticmethod
    def paragraph(text: str) -> ContentFragment: ...
    @property
    def kind(self) -> str: ...
...
class Document:
    ...
    def insert_content(
        self, destination: StoryItem | Story, fragment: ContentFragment
    ) -> None: ...
    def clone_content(self, source: StoryItem, destination: StoryItem | Story) -> None: ...
    def move_content(self, source: StoryItem, destination: StoryItem | Story) -> None: ...
    @property
    ...
    def find_content_index(self, text: str) -> int | None: ...
