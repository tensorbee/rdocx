...
|---|---|---|---|---|---|---|---|---|
| Crates.io archive: rpptx | 399,343 compressed bytes, 2,083,888 member bytes, 16 members | 0.12.1 | macOS 26.6.2, Apple M5 Max, arm64 | `cargo package --locked --no-verify` | Tracked `rpptx` package inventory | `python3 scripts/readme_doctests.py --record-measurements` | gzip archive bytes, tar member bytes, tar member count | 2026-09-19 |
